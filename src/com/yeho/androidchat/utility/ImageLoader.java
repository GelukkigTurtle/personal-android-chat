...
public class ImageLoader {
    ...
    final int stub = R.drawable.ic_launcher;

     
	
	public void DisplayImageThumbnailV2(String path, ImageView imageView) {

		imageViews.put(imageView, path);
		Bitmap bitmap = decodeSampledBitmapFromPath(path, 64, 64);
		if (bitmap != null) {
